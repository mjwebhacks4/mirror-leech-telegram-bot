...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Developer", "https://t.me/mjlearning")
    buttons.buildbutton("Support Group", "https://t.me/mjwebhack")
...
'''
        ...
        sendMarkup('Not Authorized user, contact developer to get premium access.', context.bot, update.message, reply_markup)
